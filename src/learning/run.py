...
from tuning.extras import ploting
from tuning.data import SFTDataCollatorWith4DAttentionMask, get_dataset
from tuning.model import load_model, load_tokenizer
from tuning.hparams import get_train_args
from configuration import preparation
from transformers import Seq2SeqTrainingArguments, TrainerCallback
from tuning.trainer import SFTSeq2SeqTrainer, WeightedTrainer
...
class SFTDataCollator(SFTDataCollatorWith4DAttentionMask):
    ...
    def __call__(self, features: Sequence[Dict[str, Any]]) -> Dict[str, "torch.Tensor"]:
        ...
        # print(keys)
        keys = ['input_ids', 'labels', 'probs', 'sample_id']
...
def train(callbacks :List['TrainerCallback']= [])-> None:
    ...
    print("2 -----------------")
    data_collator = SFTDataCollatorWith4DAttentionMask( # SFTDataCollatorWith4DAttentionMask
        tokenizer=tokenizer,
    ...
    trainer = SFTSeq2SeqTrainer(**kwargs)
