...
def preparation():
    ...
    # Model arguments
    parser.add_argument('--model_name_or_path', type=str, default='/Users/shizhl/Documents/huggingface/mistral-7b-inst-v0.3')
    ...
    # Dataset arguments
    parser.add_argument('--dataset_name_or_path', type=str, default='/Users/shizhl/Documents/GitHub/FactReward/dataset/test.json')
